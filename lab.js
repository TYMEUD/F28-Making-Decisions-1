...
//   console.log('wear tshirt and bring an umbrella')
// }else if(rain === true && temperature >= 60){
//   console.log('wear a rain jeacket')
// }else if(rain === true && temperature < 60){
//   console.log('wear a jacket and carry an umbrealla')
// }

// else if(rain === false && temperature >= 80){
//   console.log('wear absolutely nothing')
// }else if(rain === false && temperature >= 60){
//   console.log('wear ur drippiest fit')
// }else if(rain === false && temperature < 60){
//   console.log('wear a parka and rick owens boots')
// }
